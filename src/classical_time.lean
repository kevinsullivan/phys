...
noncomputable def classicalTimeFrameAlgebra {t : classicalTime} : classicalTimeFrame t → real_affine.r_fr 1
| (@classicalTimeFrame.standard t m) := real_affine.to_standard_frame 1
| (@classicalTimeFrame.derived t f p v m) := real_affine.to_derived_frame 1 p.val (λn : fin 1, (v n).val) (real_affine.to_coordinatized_affine_space 1 (classicalTimeFrameAlgebra f))
...
noncomputable def classicalTimeCoordinateVectorAlgebra {t : classicalTime} : classicalTimeCoordinateVector t → real_affine.Algebra :=
    λ v, real_affine.Algebra.aff_vector (real_affine.to_affine_vector_with_frame v.val (real_affine.to_coordinatized_affine_space 1 (classicalTimeFrameAlgebra v.f)))

noncomputable def classicalTimeCoordinatePointAlgebra {t : classicalTime} : classicalTimeCoordinatePoint t → real_affine.Algebra :=
    λ v, real_affine.Algebra.aff_point (real_affine.to_affine_point_with_frame v.val (real_affine.to_coordinatized_affine_space 1 (classicalTimeFrameAlgebra v.f)))
